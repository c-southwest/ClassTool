...
using System.Linq;
using System.Text;
using System.Runtime.InteropServices;  //用于调用系统API
using System.Windows.Forms;           //窗体事件

namespace 局部放大
{
    public class MouseHook
    {
        private const int WM_MOUSEMOVE = 0x200;              //鼠标移动消息常量
        ...
        private const int WM_MOUSEWHEEL = 0x020A;   //滚轮事件
        public event MouseEventHandler OnMouseActivity;     //全局的事件  
        static int hMouseHook = 0;                       //鼠标钩子句柄 
        public const int WH_MOUSE_LL = 14;                //鼠标HOOK常量
        ...
        public void Stop()
        {
            ...
            //如果卸下钩子失败   
            if (!(retMouse)) throw new Exception("卸载Hook失败.");
        }
